...
exports.insert_direct_messages = void 0;
const seed_1 = require("./seed");
async function insert_direct_messages() {
    ...
    for (let i = 0; i < directMessages.length; i++) {
        const directMessage = await seed_1.prisma.directMessage.create({
            data: directMessages[i],
        });
        console.log(`Direct message ${directMessage.id} created`);
    }
}
exports.insert_direct_messages = insert_direct_messages;
//# sourceMappingURL=direct_messages.js.map